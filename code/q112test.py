...
def test_student_introduce_method_returns_expected_string():
    ...
    assert (
        student1.introduce()
        == "Hello! I am Alice, I am 22 years old, and my current grade is 90."
    )
    assert (
        student2.introduce()
        == "Hello! I am Bob, I am 19 years old, and my current grade is 85."
    )
...
def test_student_study_method_returns_expected_string():
    ...
    assert (
        student2.study(2) == "After studying for 2 hours, Charlie's new grade is 89.0."
    )
