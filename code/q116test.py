...
@pytest.mark.it(
    "The MathOperations class includes the 'calculate_circle_area' class method"
)
...
@pytest.mark.it(
    "The 'calculate_circle_area' class method should return the expected circle area"
)
...
@pytest.mark.it(
    "The 'calculate_circle_area' class method should return the expected circle area. Testing with different values"
)
