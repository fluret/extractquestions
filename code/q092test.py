...
@pytest.mark.it(
    "Testing the function square_root with the number 50, it should return 7.07"
)
...
@pytest.mark.it(
    "Testing the function square_root with the number 2.25, it should return 1.5"
)
...
@pytest.mark.it(
    "Testing the function square_root with the number 0, it should return 0"
)
