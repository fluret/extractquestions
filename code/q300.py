...
class Product(Entity):
    ...
    def __str__(self):
        return "{amount}{scale} of {name} valued at {value}".format(
            amount=self._amount, scale=self._scale, name=self._name, value=self._value
        )
    ...
    def product_value(self):
        ...
        return sum(
            [
                ...
                for single in self._products[product]
            ]
        )
...
if __name__ == "__main__":
    ...
    for name, info in (
        ("amount of product", prod_amt),
        ("value of product", prod_val),
