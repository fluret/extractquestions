...
@pytest.mark.it(
    "Something went wrong! We tried to pass 1 as parameter and it did not return 4. Keep trying!"
)
...
@pytest.mark.it(
    "Something went wrong! We tried to pass 46 as parameter and it did not return 0. Keep trying!"
)
